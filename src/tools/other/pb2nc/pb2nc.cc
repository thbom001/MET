...
static const map<string,string> derived_var_desc_map = {
   ...
   { "D_MLCAPE", "DERIVED MIXED LAYER CONVECTIVE AVAILABLE POTENTIAL ENERGY OBSERVATION" }
};
...
void write_netcdf_hdr_data() {
   ...
   bool using_obs_vars = true;
   nc_point_obs.write_to_netcdf(nc_var_name_arr, nc_var_unit_arr,
                                nc_var_desc_arr);
